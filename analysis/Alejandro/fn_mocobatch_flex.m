...
function fn_mocobatch_flex(current_path)
    warning('off')
    addpath(genpath('/home/amonreal/Documents/PhD/tools/spm12'))
    
    cd(current_path)
    % cd /home/amonreal/Documents/PhD/PhD_2022/sosp_vaso/data/_10292022_sv_1/analysis/sv_01_02/
    ...
    % if you want to use the first, use rtm = 0, if you want to use the mean use rtm = 1
        ...
        matlabbatch{bases}.spm.spatial.realign.estwrite.eoptions.interp = 5;
