...
# cp /home/amonreal/Documents/PhD/PhD_2022/sosp_vaso/analysis/youtube/mocobatch.m ./mocobatch.m
...
################### Start here if I combine 2 runs after moco with cv_start_moco_flex.sh
...
3dDeconvolve -overwrite -jobs 16 -polort a -input VASO_LN.nii\
             -num_stimts 1 \
             -TR_times 1 \
             -stim_times 1 '1D: 0 64 128 192 256 320 384 448 512' 'UBLOCK(32,1)' -stim_label 1 Task \
             -tout \
             -x1D MODEL_wm \
